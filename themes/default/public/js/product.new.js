var Product = function(){
	...
	var handleCheckOutCart = function(){
		...
		chooseChangeProvince('.order_right #country-dd2','.order_right #region-state-dd2');
				...
				if(!isNaN(provinceid)){
					$('.order_right #country-dd2 option').each(function(index, el) {
						if($(this).val()==provinceid){
							...
							.done(function(data) {
								$('.order_right #region-state-dd2').html(data.html);
