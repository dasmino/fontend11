...
if (!function_exists('base_url_fontend')){
        function base_url_fontend(){
            global $_web;
            return $_web['base_url_fontend'];
        }
}
if (!function_exists('base_url_cloud')){
        function base_url_cloud(){
            global $_web;
            return $_SESSION['base_url_cloud'];
        }
}
...
if (!function_exists('Image')){
        function Image($url_root,$url,$width,$height,$action){
            return $url_root.'timthumb.php?src='.$url.'&h='.$height.'&w='.$width.'&zc='.$action;
        }
}
...
if (!function_exists('getImagesToFolder')){
        function getImagesToFolder($dir){
            $ImagesArray = [];
            $file_display = [ 'jpg', 'jpeg', 'png', 'ico', 'gif'];
