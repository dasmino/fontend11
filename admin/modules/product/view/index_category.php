                                          ...
                                          <div class="col-lg-4" style="text-align: right;">
                                            ...
                                            <div class="btn-group">
                                              ...
                                              <ul class="dropdown-menu">
                                                <?php if(preg_match("/,90,/",$_SESSION['permission_id'], $matches) || $_SESSION['id'] == $value['create_author'] || $_SESSION['group_id'] == '20'){ ?>
                                                  <li><a href="javascript:void(0)" id="del_list_product"><i class="fa fa-trash-o" aria-hidden="true"></i> &nbsp;<?php echo lang('delete');?></a></li>
                                                <?php } ?> 
                                                <?php if(preg_match("/,89,/",$_SESSION['permission_id'], $matches) || $_SESSION['id'] == $value['create_author'] || $_SESSION['group_id'] == '20'){ ?>
                                                ...
                                                if (!empty($this->data['data'])) {
                                                    foreach ($this->data['data'] as $key => $value) { ?>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>
                                                                <img src="<?php echo (isset($value['avatar']) && $value['avatar']!='') ? base_url_cloud().'timthumb.php?src='.base_url_cloud().'cdn/'.$value['avatar'].'&h=100&w=150&zc=2' : base_url().'tmp/public/plugins/image_tools/timthumb.php?src='.base_url().'tmp/public/images/img.png&h=100&w=150&zc=2'; ?>" width="150" height="100" class="img-thumbnail"/>
                                                            </td>
                                                            ...
                                                            <td>
                                                            <?php if(preg_match("/,89,/",$_SESSION['permission_id'], $matches) || $_SESSION['id'] == $value['create_author'] || $_SESSION['group_id'] == '20'){ ?>
                                                              <a href="<?php echo base_url().'product/category/edit/'.$value['id'];?>" class="btn btn-icon btn-primary tip" data-original-title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i><!--<i class="fa fa-eye"></i>--></a>
                                                            <?php } ?>
                                                            &nbsp;
                                                            <?php if(preg_match("/,90,/",$_SESSION['permission_id'], $matches) || $_SESSION['id'] == $value['create_author'] || $_SESSION['group_id'] == '20'){ ?>
                                                              <a data-toggle="modal" data-target="#modelDelete" data-href="<?php echo base_url().'product/category/del/'.$value['id'];?>" class="btn btn-icon btn-danger deleteDialog tip"><i class="fa fa-trash-o"></i></a>
                                                            <?php } ?>
                                                            </td>
                                                        </tr>
                                                <?php } } ?>
