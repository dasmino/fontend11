			                      ...
			                      <br>
			                        ...
			                        <div class="modal-image-choose">
			                            <div class="text-center">
			                                  ...
			                                  <img src="<?php echo (isset($this->data['data']['avatar']) && $this->data['data']['avatar']!='') ? base_url_cloud().'timthumb.php?src='.base_url_cloud().'cdn/'.$this->data['data']['avatar'].'&h=150&w=210&zc=2' : base_url().'tmp/public/images/img.png';?>" class="logo-website pages-website load-img" alt="" />
			                        ...
			                        <div class="modal-image-choose">
			                            <div class="text-center">
			                                  ...
			                                  <img src="<?php echo (isset($this->data['data']['background']) && $this->data['data']['background']!='') ? base_url_cloud().'timthumb.php?src='.base_url_cloud().'cdn/'.$this->data['data']['background'].'&h=150&w=210&zc=2' : base_url().'tmp/public/images/img.png';?>" class="logo-favicon load-img" alt="">
