<div class="content-wrapper" id="body">
    ...
    <section class="content">
      ...
      <div class="row">
        	...
        	<form action="<?php echo base_url().'banners/banners/save'?>"
			                      ...
			                      <br>
			                        <div class="modal-image-choose">
			                            <div class="text-center">
			                                  ...
			                                  <img src="<?php echo (isset($this->data['data']['images']) && $this->data['data']['images']!='') ? base_url_cloud().'timthumb.php?src='.base_url_cloud().'cdn/'.$this->data['data']['images'].'&h=150&w=210&zc=2' : base_url().'tmp/public/plugins/image_tools/timthumb.php?src='.base_url().'tmp/public/images/img.png&h=150&w=210&zc=2';?>" id="uploadPreview" class="logo-website pages-website load-img" alt="" />
			                                  <input type="hidden" id="hidden_thumb_pages" class="hidden_thumb_pages" name="hidden_thumb_pages"  value="<?php if(isset($this->data['data']['images'])) echo $this->data['data']['images']; ?>"/>
			                                  </a>
