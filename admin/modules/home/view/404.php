                ...
                <div class="error-template">
                    ...
                    <div class="error-actions">
                        <a href="<?php echo base_url();?>" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-home"></span>
                            Take Me Home </a><a href="skype:cuongle059" class="btn btn-default btn-lg"><i class="fa fa-skype fa-4" aria-hidden="true"></i> Contact Support </a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="child-footer">
       <div class="container">
           <div class="row">
                ...
                <strong>Copyright &copy; 2016 <a href="https://fb.com/lengoccuongth" target="_blank">Cuongle</a>.</strong> All rights
                reserved.
           </div>
       </div>
      </footer>
