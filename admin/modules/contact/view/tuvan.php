                                                ...
                                                if (!empty($this->data['data'])) {
                                                    foreach ($this->data['data'] as $key => $value) { ?>
                                                                ...
                                                                <div class="modal-dialog">
                                                                  ...
                                                                  <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                      ...
                                                                      <p> <label><?php echo lang('diachi');?>      : </label> <?php echo $value['diachi']; ?></p>
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td><a data-toggle="modal" data-target="#modelView<?php echo $value['id']; ?>" class="btn btn-icon btn-primary tip"><i class="fa fa-eye" aria-hidden="true"></i></a>&nbsp;<a data-toggle="modal" data-target="#modelDelete" data-href="<?php echo base_url().'tuvan/tuvan/del/'.$value['id'];?>" class="btn btn-icon btn-danger deleteDialog tip"><i class="fa fa-trash-o"></i></a></td>
                                                        </tr>
                                                <?php 
                                                    }
                                                }
