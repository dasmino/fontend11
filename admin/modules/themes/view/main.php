...
<?php if (isset($this->data['body_theme']->main)) {
    $array = get_object_vars($this->data['body_theme']->main);
    $properties = array_keys($array);
    if($this->data['body_theme']->main->col == 3){
        $class_main = "col-md-4";
    }else if($this->data['body_theme']->main->col == 2){
        $class_main = "col-md-6";
    }else{
