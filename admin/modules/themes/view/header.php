...
<?php if (isset($this->data['body_theme']->header)) {
    $array = get_object_vars($this->data['body_theme']->header);
    $properties = array_keys($array);
    if($this->data['body_theme']->header->col == 3){
        $class_header = "col-md-4";
    }else if($this->data['body_theme']->header->col == 2){
        $class_header = "col-md-6";
    }else{
        $class_header = "col-md-12";
    }
?>
