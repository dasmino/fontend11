...
<?php if (isset($this->data['body_theme']->session_top)) {
 
    $array = get_object_vars($this->data['body_theme']->session_top);
    $properties = array_keys($array);
    if($this->data['body_theme']->session_top->col == 3){
        $class_session_top = "col-md-4";
    }else if($this->data['body_theme']->session_top->col == 2){
        $class_session_top= "col-md-6";
    }else{
        $class_session_top = "col-md-12";
    }
?>

    <h3 style='text-align: center;'>Session Top</h3>

    <div class="<?php echo $class_session_top; ?>">
        <div class="widget">
