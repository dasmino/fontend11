                                    ...
                                    <div id="datatables_filter" class="dataTables_filter">
                                        <div class="row">
                                          ...
                                          <div class="col-lg-4" style="text-align: right;">
                                            <a class="btn btn-success"  href="<?php echo base_url().'posts/posts/add';?>"><i class="fa fa-plus-circle"></i> <?php echo lang('add_news');?></a>
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th>
                                                    <a class="sorting_1" href=""><?php echo lang('title');?></a>
                                                </th>
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($this->data['data'])) {
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <img src="<?php echo (isset($value['thumbnail']) && $value['thumbnail']!='') ? base_url_cloud().'timthumb.php?src='.base_url_cloud().'cdn/'.$value['thumbnail'].'&h=100&w=150&zc=2' : base_url().'tmp/public/plugins/image_tools/timthumb.php?src='.base_url().'tmp/public/images/img.png&h=100&w=150&zc=2'; ?>" width="150" height="100" class="img-thumbnail"/>
                                                    </td>
                                                    <td class="sorting_1"><?php echo stripslashes($value['title']);?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?php echo base_url().'posts/posts/edit/'.$value['id'];?>" class="btn btn-icon btn-primary tip" data-original-title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i><!--<i class="fa fa-eye"></i>--></a>&nbsp;
                                                        <?php } ?>
                                                        <?php if(preg_match("/,62,/",$_SESSION['permission_id'], $matches) || $_SESSION['group_id'] == '20' || $_SESSION['id'] == $value['author_create']){ ?>
                                                        <a data-toggle="modal" data-target="#modelDelete" data-href="<?php echo base_url().'posts/posts/del/'.$value['id'];?>" class="btn btn-icon btn-danger deleteDialog tip"><i class="fa fa-trash-o"></i></a>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                                    <?php 
