        ...
        <div class="col-md-4">
            <div class="list-group config-item">
                <a href="<?php echo base_url().'posts/manager/index';?>" class="list-group-item">
                    ...
                    <p class="list-group-item-text"><?php echo lang('manage_view_home_post');?></p>
                </a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="list-group config-item">
                <a href="<?php echo base_url().'posts/widgets/index';?>" class="list-group-item">
                    <i class="fa fa-cog fa-spin" aria-hidden="true" style="font-size: 40px;float: left;margin-right:20px;"></i>
                    <h4 class="list-group-item-heading"><?php echo lang('manager_show_index');?> 2</h4>
                    <p class="list-group-item-text"><?php echo lang('manage_view_home_post');?> </p>
                </a>
            </div>
        </div>
